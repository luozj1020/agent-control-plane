  ...
  switch (mode.kind) {
    ...
    case "interactive":
      return [
        ...
        "Select installed custom agents by their names, descriptions, configured permissions, and developer instructions; do not assume a fixed role list.",
        "Delegate each bounded task to the narrowest suitable role and use an independent review role after implementation when the configured roles provide one.",
