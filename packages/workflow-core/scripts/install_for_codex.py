...
def parse_args(argv=None):
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Install optional aiwf_* specializations for Codex-native subagents. "
            "Interactive mode works with built-in roles without this flag."
        ),
    )
    parser.add_argument(
        "--agent-model",
...
def install_agents(skill_dir, agent_model="spark", override_built_in=False, summary_only=False):
    """Install optional aiwf_* specializations for native Codex subagents.
